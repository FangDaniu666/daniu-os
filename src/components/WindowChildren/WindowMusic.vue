<template>
    <Window :uuid='uuid' :startpos_x="startpos_x" :startpos_y="startpos_y" :zindex="zindex"
            :default_width="default_width" :default_height="default_height" :fixedsize="fixedsize"
            :minimized="minimized">
        <template v-slot:header>
            <div class="tw-flex tw-items-center tw-select-none" style="pointer-events:none;">
                <img src="../../assets/images/icons/music.png" alt="" style="pointer-events:auto;"
...
export default {
    ...
    created() {
        ...
        let config = {
            ...
            url: this.$store.state.base_url + '/music/selectAll',
            headers: {}
        };
        ...
        axios.request(config)
            .then((res) => {
                ...
                res.data.forEach(item => {
                    item.src = encodeURI(this.$store.state.base_url + item.src);
                    item.pic = encodeURI(this.$store.state.base_url + item.pic);
                });
